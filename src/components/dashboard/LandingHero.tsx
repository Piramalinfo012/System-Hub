...
export const LandingHero: React.FC = () => {
  return (
    <div className="relative min-h-screen overflow-hidden bg-[#f0f0ee] rounded-3xl mb-8 border border-slate-200 dark:border-slate-800 shadow-2xl">
      <video
        autoPlay
        muted
        loop
      ...
      <div className="relative z-10 flex flex-col min-h-screen">
        <nav className="hidden items-center justify-center pt-4 sm:pt-6 px-4 sm:px-8 gap-2 sm:gap-3">
          <div 
        ...
        <div className="flex-1 flex items-end pb-10 sm:pb-16 lg:pb-20 px-6 sm:px-12 md:px-20 lg:px-28">
          <div className="max-w-xs">
            <a href="#" className="inline-flex items-center gap-1.5 text-[11.5px] font-medium text-blue-500 hover:text-blue-600 transition-colors mb-3 group">
            ...
            <a href="#" className="inline-flex items-center gap-2 text-[13px] font-medium text-blue-500 border border-blue-400 rounded-full px-5 py-2.5 hover:bg-blue-500 hover:text-white hover:border-blue-500 transition-all duration-200 group">
