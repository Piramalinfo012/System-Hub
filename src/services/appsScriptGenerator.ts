export const SPREADSHEET_ID = "11PUbLKLKiXiQG4H-XEKvi-EZYY9Yv5oMinTOdHqXN9A";
export const DEFAULT_SCRIPT_URL = "https://script.google.com/macros/s/AKfycbxEHfkGif0LSF3vzgOEXrMK9F9ZVpVauz_qV_QmZcpA4QWqsmpnVSAv6zAK2dce2YX3Qw/exec";

export const APPS_SCRIPT_SOURCE_CODE = `// Sheet ID changing is compulsory
